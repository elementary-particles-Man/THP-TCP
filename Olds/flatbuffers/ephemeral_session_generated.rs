...
impl<'a> EphemeralSession<'a> {
  ...
  pub fn expiration_unix(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(EphemeralSession::VT_EXPIRATION_UNIX, Some(0)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for EphemeralSession<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<u64>("expiration_unix", Self::VT_EXPIRATION_UNIX, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> EphemeralSessionBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_expiration_unix(&mut self, expiration_unix: u64) {
    self.fbb_.push_slot::<u64>(EphemeralSession::VT_EXPIRATION_UNIX, expiration_unix, 0);
  }
  #[inline]
